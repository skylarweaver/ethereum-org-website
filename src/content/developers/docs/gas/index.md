...
Prior to [the London Upgrade](/history/#london) of August 2021, the way transaction fees on the Ethereum network are calculated changed during the London network upgrade. Here is a recap of how things used to work:
